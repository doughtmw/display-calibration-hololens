...
public class UserDefinedCameraCalibrationParams : MonoBehaviour
{
    // Calibration parameters from opencv, compute once for each hololens 2 device OR use per-frame intrinsics
    ...
    //504, 896); // image height and width
